...
const Auth = () => {
  ...
  function validate() {
    ...
    if (!isLogin && !name) errors.name = 'Full name is required.';
  ...
  async function handleSubmit (e: React.FormEvent){
    ...
    try {
      ...
      setSuccessMessage(data?.message || (isLogin ? 'Signed in' : 'Account created'));
    } catch (err: any) {
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-5xl grid md:grid-cols-2 gap-0 relative z-10">
        {/* Brand Side */}
        <div className="hidden md:flex flex-col justify-center p-12 bg-gradient-to-br from-primary/20 via-accent/20 to-secondary/20 rounded-l-3xl border border-border/50 relative overflow-hidden">
          <div className="absolute inset-0 bg-card/30 backdrop-blur-sm" />
          <div className="relative z-10">
            <div className="flex items-center gap-2 mb-6">
              <Sparkles className="w-8 h-8 text-primary" />
              <span className="text-4xl font-black gradient-text">BookIt</span>
            </div>
            <h2 className="text-3xl font-bold text-foreground mb-4">
              Your Next Adventure Awaits
            </h2>
            <p className="text-muted-foreground text-lg mb-8">
              Join thousands of event lovers discovering amazing experiences every day.
            </p>
        ...
        {/* Form Side */}
        <div className="glass-card p-8 md:p-12 md:rounded-l-none rounded-3xl md:rounded-r-3xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            {!isLogin && (
              <div className="space-y-2">
                ...
                {fieldErrors.name && <div className="text-sm text-red-500">{fieldErrors.name}</div>}
              </div>
            )}
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  placeholder="••••••••"
                  className="pl-12 pr-12 h-12 bg-muted/50 border-border/50"
                  value={password}
            ...
            <Button type="submit" variant="gradient" className="w-full h-12 text-lg" disabled={loading}>
